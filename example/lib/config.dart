...
class ListenerConfig with ChangeNotifier, DiagnosticableTreeMixin {
  ...
  static const String appKey = "f442d0cca069bbcc8ced55f4f113b965999b928c78e3cd83495728133a06f4cb";
  ...
  Future<int> initSDK() async {
    ...
    if (initSDKRes.code == 0) {
      //初始化成功
      GenerateDevUsersigForTest generateDevUsersigForTest = GenerateDevUsersigForTest(sdkappid: sdkappid, key: appKey);
      String userSig = generateDevUsersigForTest.genSig(identifier: userid, expire: expireTime);
